...
//                        console.log(index)
        ...
        function UndoManager() {
            ...
            this.restore = function() {
                ...
                var range = new ns.Range( me.document );
            ...
            this.save = function(notCompareRange) {
                ...
                if ( lastScene && lastScene.content == currentScene.content &&
                    (
                        notCompareRange ? 1 :lastScene.bookcontent == currentScene.bookcontent
                        )
                    ) {
                    return;
                }
        ...
        me.on( 'beforeexeccommand', saveScene );
        me.on( 'afterexeccommand', saveScene );

        me.on('reset',function(type,exclude){
            if(!exclude){
                me.undoManger.reset();
            }
        });
        ...
        me.on( 'keydown', function( type, evt ) {
