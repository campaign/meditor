...
(function() {
    function mySetup() {
        ...
        var editor = new ME.Editor({'UEDITOR_HOME_URL':'../../../','initialContent':'<p>欢迎使用ueditor</p>','autoFloatEnabled':false});

//        var ue = new ME.ui.Editor({'UEDITOR_HOME_URL':'../../../','autoFloatEnabled':true});
